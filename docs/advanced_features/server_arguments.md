...
| `--enable-return-routed-experts` | Enable returning FFN expert routing and, for MoVA models, value expert routing with responses. | `False` | bool flag (set to enable) |
