...
class GenerationBatchResult:
    ...
    def copy_to_cpu(self, return_logprob: bool):
        ...
        if return_logprob:
            ...
            if self.logits_output.next_token_nucleus_token_ids is not None:
                self.logits_output.next_token_nucleus_token_ids = [
                    v.to("cpu", non_blocking=True) if torch.is_tensor(v) else v
                    for v in self.logits_output.next_token_nucleus_token_ids
                ]
...
def get_logprob_dict_from_result(result: GenerationBatchResult) -> dict:
    ...
    return {
        ...
        "next_token_nucleus_token_ids": result.logits_output.next_token_nucleus_token_ids,
...
def get_logprob_from_pp_outputs(
    ...
    logits_output = LogitsProcessorOutput(
        ...
        next_token_nucleus_token_ids=next_pp_outputs["next_token_nucleus_token_ids"],
